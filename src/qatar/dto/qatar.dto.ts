...
export class CreateFlightDto {
  @ApiProperty({ example: 'QTA101' })
  @IsString()
  number: string;

  @ApiProperty({ example: 'الدوحة' })
  @IsString()
  from: string;

  @ApiProperty({ example: 'نيويورك' })
  @IsString()
  to: string;
...
export class UpdateFlightDto {
  @ApiProperty({ example: 'QTA101', required: false })
  @IsString()
  @IsOptional()
  number?: string;

  @ApiProperty({ example: 'الدوحة', required: false })
  @IsString()
  @IsOptional()
  from?: string;

  @ApiProperty({ example: 'نيويورك', required: false })
  @IsString()
  @IsOptional()
  to?: string;
  ...
  @ApiProperty({ example: '15:45', required: false })
  @IsString()
  @IsOptional()
  arrivalTime?: string;
...
export class CreateBookingDto {
  ...
  @ApiProperty({ example: 'قطري' })
  @IsString()
  @IsNotEmpty()
  nationality: string;

  @ApiProperty({ example: '+974123456789' })
  @IsString()
  @IsNotEmpty()
  phone: string;
